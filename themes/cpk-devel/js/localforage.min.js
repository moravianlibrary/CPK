...
localforage.clearTheCrumbs = function() {
    var useConsole = true;
    var crumbs = ['notifies'];

    crumbs.forEach(function(crumb) {
	localforage.removeItem(crumb, function(err) {
	    if (useConsole)
		if (!err) {
		    console.log("Crumbs were successfully cleared from the floor! ;)");
		} else {
		    console.error("ATTENTION! Could not clear the crumbs from the floor! :O Please contact the system administrator. \n Crumb with problem: " + crumb);
		}		
	});	
    });
}