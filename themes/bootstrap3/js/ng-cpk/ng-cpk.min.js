...
c.created();b[e].remove();delete b[e];--m.listLength;0===Object.keys(b).length&&p();m.favorites=m.favorites.filter(function(a){return a.created()!==c.created()});a()})).then(l.$applyAsync))}}angular.module("favorites").controller("ListController",a).directive("favoritesListItem",function(){return{restrict:"A",templateUrl:"/themes//js/ng-cpk/favorites/list-item.html",link:function(a,c,d){b[a.fav.created()]=c.context}}}).directive("listNotEmpty",function(){return{restrict:"A",link:function(a,
bootstrap3
