...
/* feature-1264 */
ALTER TABLE `widget` ADD COLUMN `title_en` varchar(128) COLLATE utf8_unicode_ci NOT NULL AFTER `title_cs`;
UPDATE `widget` SET `title_en` = "You know that ..." WHERE `name` = "Infobox";
UPDATE `widget` SET `title_en` = "Popular" WHERE `name` = "nejpujcovanejsi_2015";
UPDATE `widget` SET `title_en` = "Events" WHERE `name` = "Akce";
UPDATE `widget` SET `title_en` = "Favorite authors" WHERE `name` = "Oblíbení autoři";
UPDATE `widget` SET `title_en` = "Known from TV" WHERE `name` = "znate_z_kina_a_televize";
UPDATE `widget` SET `title_en` = "Classic literature available online" WHERE `name` = "online_dostupna_klasicka_literatura";
UPDATE `widget` SET `title_en` = "Magnesia Litera" WHERE `name` = "magnesia_litera";
UPDATE `widget` SET `title_en` = "Nobel Prize in Literature" WHERE `name` = "nobelova_cena_za_literaturu";
UPDATE `widget` SET `title_en` = "Children´s Books" WHERE `name` = "cteni_pro_deti";
UPDATE `widget` SET `title_en` = "Nebula and Hugo Awards" WHERE `name` = "ceny_nebula_a_hugo";
UPDATE `widget` SET `title_en` = "Back to School" WHERE `name` = "zpatky_do_skoly";
UPDATE `widget` SET `title_en` = "Zlatá stuha Award" WHERE `name` = "zlata_stuha";
UPDATE `widget` SET `title_en` = "Audio books" WHERE `name` = "audiobooks";
UPDATE `widget` SET `title_en` = "Free ebooks" WHERE `name` = "eknihy_ke_stazeni";
UPDATE `widget` SET `title_en` = "Christmas" WHERE `name` = "christmas";
UPDATE `widget` SET `title_en` = "Easter" WHERE `name` = "velikonoce";
UPDATE `widget` SET `title_en` = "Healthy diet" WHERE `name` = "zdravavyziva";
UPDATE `widget` SET `title_en` = "1620: Battle of White Mountain" WHERE `name` = "1620_battle";
UPDATE `widget` SET `title_en` = "1805: Battle of Austerlitz" WHERE `name` = "1805_battle";
UPDATE `widget` SET `title_en` = "1918: Creation of Czechoslovakia" WHERE `name` = "1918_czechoslovakia";
UPDATE `widget` SET `title_en` = "1968: Warsaw Pact invasion of Czechoslovakia" WHERE `name` = "1968_warsaw_pack";
UPDATE `widget` SET `title_en` = "Bernard Cornwell" WHERE `name` = "bernard_cornwell";
UPDATE `widget` SET `title_en` = "Brandon Sanderson" WHERE `name` = "brandon_sanderson";
UPDATE `widget` SET `title_en` = "Brno" WHERE `name` = "brno";
UPDATE `widget` SET `title_en` = "C. S. Lewis" WHERE `name` = "c_s_lewis";
UPDATE `widget` SET `title_en` = "Hugo Award" WHERE `name` = "hugo_award";
UPDATE `widget` SET `title_en` = "Jaroslav Seifert Prize" WHERE `name` = "seifert_prize";
UPDATE `widget` SET `title_en` = "Jiří Orten Award" WHERE `name` = "orten_award";
UPDATE `widget` SET `title_en` = "Josef Škvorecký Award" WHERE `name` = "skvorecky_award";
UPDATE `widget` SET `title_en` = "Nebula Award" WHERE `name` = "nebula_award";
UPDATE `widget` SET `title_en` = "Czech science faction" WHERE `name` = "czech_scifi";
UPDATE `widget` SET `title_en` = "Presidents of Czechoslovakia" WHERE `name` = "czechoslovakia_presidents";
UPDATE `widget` SET `title_en` = "Jára Cimrman Theatre" WHERE `name` = "jara_cimrman";
UPDATE `widget` SET `title_en` = "Mental health" WHERE `name` = "mental_health";
UPDATE `widget` SET `title_en` = "Eliška Krásnohorská" WHERE `name` = "eliska_krasnohorska";
UPDATE `widget` SET `title_en` = "Football" WHERE `name` = "football";
UPDATE `widget` SET `title_en` = "G. B. Shaw" WHERE `name` = "g_b_shaw";
UPDATE `widget` SET `title_en` = "George R. R. Martin" WHERE `name` = "grr_martin";
UPDATE `widget` SET `title_en` = "Guillaume Apollinaire" WHERE `name` = "apollinaire";
UPDATE `widget` SET `title_en` = "House of Habsburg" WHERE `name` = "habsburg";
UPDATE `widget` SET `title_en` = "Heraldry" WHERE `name` = "heraldry";
UPDATE `widget` SET `title_en` = "History of czech postal system" WHERE `name` = "postal_system";
UPDATE `widget` SET `title_en` = "History of Science and Technology" WHERE `name` = "science_history";
UPDATE `widget` SET `title_en` = "Holocaust" WHERE `name` = "holocaust";
UPDATE `widget` SET `title_en` = "Humorous literature" WHERE `name` = "humorous";
UPDATE `widget` SET `title_en` = "J. R. R. Tolkien" WHERE `name` = "tolkien";
UPDATE `widget` SET `title_en` = "Jaroslav Foglar" WHERE `name` = "foglar";
UPDATE `widget` SET `title_en` = "Jaroslav Seifert" WHERE `name` = "seifert";
UPDATE `widget` SET `title_en` = "Cactus and succulents" WHERE `name` = "cactus";
UPDATE `widget` SET `title_en` = "Karel Čapek" WHERE `name` = "Karel Čapek";
UPDATE `widget` SET `title_en` = "Charles IV" WHERE `name` = "charles_IV";
UPDATE `widget` SET `title_en` = "Cats" WHERE `name` = "cats";
UPDATE `widget` SET `title_en` = "Horse racing" WHERE `name` = "horse_racing";
UPDATE `widget` SET `title_en` = "Cookbooks" WHERE `name` = "cookbooks";
UPDATE `widget` SET `title_en` = "Ice hockey" WHERE `name` = "hockey";
UPDATE `widget` SET `title_en` = "House of Luxembourg" WHERE `name` = "luxembourg";
UPDATE `widget` SET `title_en` = "Maria Theresa" WHERE `name` = "maria_theresa";
UPDATE `widget` SET `title_en` = "Martin Luther" WHERE `name` = "martin_luther";
UPDATE `widget` SET `title_en` = "Michal Viewegh" WHERE `name` = "michal_viewegh";
UPDATE `widget` SET `title_en` = "Mineralogy" WHERE `name` = "mineralogy";
UPDATE `widget` SET `title_en` = "For travel" WHERE `name` = "for_travel";
UPDATE `widget` SET `title_en` = "Czech National Revival" WHERE `name` = "national_revival";
UPDATE `widget` SET `title_en` = "Bestsellers 2015" WHERE `name` = "bestsellers_2015";
UPDATE `widget` SET `title_en` = "Bestsellers 2016" WHERE `name` = "bestsellers_2016";
UPDATE `widget` SET `title_en` = "Bestsellers 2017" WHERE `name` = "bestsellers_2017";
UPDATE `widget` SET `title_en` = "Olomouc" WHERE `name` = "olomouc";
UPDATE `widget` SET `title_en` = "Liberated Theatre" WHERE `name` = "liberated_theatre";
UPDATE `widget` SET `title_en` = "Dogs" WHERE `name` = "dogs";
UPDATE `widget` SET `title_en` = "Houseplants" WHERE `name` = "houseplants";
UPDATE `widget` SET `title_en` = "Prague" WHERE `name` = "prague";
UPDATE `widget` SET `title_en` = "House of Přemyslid" WHERE `name` = "premyslid";
UPDATE `widget` SET `title_en` = "Knights Templar" WHERE `name` = "templars";
UPDATE `widget` SET `title_en` = "Robert Fulghum" WHERE `name` = "robert_fulghum";
UPDATE `widget` SET `title_en` = "Handicraft - knitting and crocheting" WHERE `name` = "knitcrocet";
UPDATE `widget` SET `title_en` = "Scandinavian crime novels" WHERE `name` = "scandinavian_crime";
UPDATE `widget` SET `title_en` = "Scouting" WHERE `name` = "scout";
UPDATE `widget` SET `title_en` = "Star Trek" WHERE `name` = "star_trek";
UPDATE `widget` SET `title_en` = "Star Wars" WHERE `name` = "star_wars";
UPDATE `widget` SET `title_en` = "Terry Pratchett" WHERE `name` = "terry_pratchett";
UPDATE `widget` SET `title_en` = "House of Tudor" WHERE `name` = "tudors";
UPDATE `widget` SET `title_en` = "Warhammer" WHERE `name` = "warhammer";
UPDATE `widget` SET `title_en` = "Warhammer 40 000" WHERE `name` = "warhammer_40000";
UPDATE `widget` SET `title_en` = "Winston Churchill" WHERE `name` = "winston_churchill";
UPDATE `widget` SET `title_en` = "International law" WHERE `name` = "international_law";
UPDATE `widget` SET `title_en` = "Economy" WHERE `name` = "economy";
UPDATE `widget` SET `title_en` = "Public administration" WHERE `name` = "public_administration";
UPDATE `widget` SET `title_en` = "Beer - brewing - breweries" WHERE `name` = "beer";
UPDATE `widget` SET `title_en` = "Rail transport and trains" WHERE `name` = "trains";
UPDATE `widget` SET `title_en` = "Homeschooling and community education" WHERE `name` = "community_edu";
UPDATE `widget` SET `title_en` = "Fishkeeping" WHERE `name` = "fishkeeping";
UPDATE `widget` SET `title_en` = "RAW FOOD" WHERE `name` = "raw_food";
UPDATE `widget` SET `title_en` = "Traveling and traveling together" WHERE `name` = "traveling";
UPDATE `widget` SET `title_en` = "Gardening" WHERE `name` = "gardening";
UPDATE `widget` SET `title_en` = "Jogging" WHERE `name` = "jogging";
UPDATE `widget` SET `title_en` = "Japan" WHERE `name` = "japan";
UPDATE `widget` SET `title_en` = "Josef Lada" WHERE `name` = "josef_lada";
UPDATE `widget` SET `title_en` = "50 ebooks for new e-reader" WHERE `name` = "top_50_ebooks";
UPDATE `widget` SET `title_en` = "Christmas shopping" WHERE `name` = "christmas_gifts";
UPDATE `widget` SET `title_en` = "Karel Čapek" WHERE `name` = "karel_capek";
UPDATE `widget` SET `title_en` = "Jan Evangelista Purkyně" WHERE `name` = "purkyne";
UPDATE `widget` SET `title_en` = "Century of tramping" WHERE `name` = "century_of_tramping";
UPDATE `widget` SET `title_en` = "International Relationships" WHERE `name` = "irel_international_relationships";
UPDATE `widget` SET `title_en` = "Music" WHERE `name` = "mus_musica";
UPDATE `widget` SET `title_en` = "Technology" WHERE `name` = "tech_technica";
UPDATE `widget` SET `title_en` = "Library Science" WHERE `name` = "kiv_library_science";
UPDATE `widget` SET `title_en` = "Events" WHERE `name` = "events";
...
UPDATE `widget` SET `title_cs` = "Oblíbení autoři" WHERE `name` = "Oblíbení autoři";
UPDATE `widget` SET `title_cs` = "Znáte z kina a televize" WHERE `name` = "znate_z_kina_a_televize";
UPDATE `widget` SET `title_cs` = "Online dostupná klasická literatura" WHERE `name` = "online_dostupna_klasicka_literatura";
UPDATE `widget` SET `title_cs` = "Magnesia Litera" WHERE `name` = "magnesia_litera";
UPDATE `widget` SET `title_cs` = "Nobelova cena za literaturu" WHERE `name` = "nobelova_cena_za_literaturu";
UPDATE `widget` SET `title_cs` = "Čtení pro děti" WHERE `name` = "cteni_pro_deti";
UPDATE `widget` SET `title_cs` = "Ceny Nebula a Hugo" WHERE `name` = "ceny_nebula_a_hugo";
UPDATE `widget` SET `title_cs` = "Zpátky do školy" WHERE `name` = "zpatky_do_skoly";
UPDATE `widget` SET `title_cs` = "Zlatá stuha" WHERE `name` = "zlata_stuha";
UPDATE `widget` SET `title_cs` = "Audioknihy" WHERE `name` = "audiobooks";
UPDATE `widget` SET `title_cs` = "E-knihy ke stažení" WHERE `name` = "eknihy_ke_stazeni";
UPDATE `widget` SET `title_cs` = "Vánoce" WHERE `name` = "christmas";
UPDATE `widget` SET `title_cs` = "Velikonoce" WHERE `name` = "velikonoce";
UPDATE `widget` SET `title_cs` = "Zdravá výživa" WHERE `name` = "zdravavyziva";
UPDATE `widget` SET `title_cs` = "1620: Bílá hora" WHERE `name` = "1620_battle";
UPDATE `widget` SET `title_cs` = "1805: bitva u Slavkova" WHERE `name` = "1805_battle";
UPDATE `widget` SET `title_cs` = "1918: vznik ČSR" WHERE `name` = "1918_czechoslovakia";
UPDATE `widget` SET `title_cs` = "1968: Invaze vojsk Varšavské smlouvy do Československa" WHERE `name` = "1968_warsaw_pack";
UPDATE `widget` SET `title_cs` = "Bernard Cornwell" WHERE `name` = "bernard_cornwell";
UPDATE `widget` SET `title_cs` = "Brandon Sanderson" WHERE `name` = "brandon_sanderson";
UPDATE `widget` SET `title_cs` = "Brno" WHERE `name` = "brno";
UPDATE `widget` SET `title_cs` = "C. S. Lewis" WHERE `name` = "c_s_lewis";
UPDATE `widget` SET `title_cs` = "Cena Hugo" WHERE `name` = "hugo_award";
UPDATE `widget` SET `title_cs` = "Cena Jaroslava Seiferta" WHERE `name` = "seifert_prize";
UPDATE `widget` SET `title_cs` = "Cena Jiřího Ortena" WHERE `name` = "orten_award";
UPDATE `widget` SET `title_cs` = "Cena Josefa Škvoreckého" WHERE `name` = "skvorecky_award";
UPDATE `widget` SET `title_cs` = "Cena Nebula" WHERE `name` = "nebula_award";
UPDATE `widget` SET `title_cs` = "Česká fantastika" WHERE `name` = "czech_scifi";
UPDATE `widget` SET `title_cs` = "Českoslovenští prezidenti" WHERE `name` = "czechoslovakia_presidents";
UPDATE `widget` SET `title_cs` = "Divadlo Járy Cimrmana" WHERE `name` = "jara_cimrman";
UPDATE `widget` SET `title_cs` = "Duševní zdraví" WHERE `name` = "mental_health";
UPDATE `widget` SET `title_cs` = "Eliška Krásnohorská" WHERE `name` = "eliska_krasnohorska";
UPDATE `widget` SET `title_cs` = "Fotbal" WHERE `name` = "football";
UPDATE `widget` SET `title_cs` = "G. B. Shaw" WHERE `name` = "g_b_shaw";
UPDATE `widget` SET `title_cs` = "George R. R. Martin" WHERE `name` = "grr_martin";
UPDATE `widget` SET `title_cs` = "Guillaume Apollinaire" WHERE `name` = "apollinaire";
UPDATE `widget` SET `title_cs` = "Habsburkové" WHERE `name` = "habsburg";
UPDATE `widget` SET `title_cs` = "Heraldika" WHERE `name` = "heraldry";
UPDATE `widget` SET `title_cs` = "Historie českého poštovnictví" WHERE `name` = "postal_system";
UPDATE `widget` SET `title_cs` = "Historie vědy a techniky" WHERE `name` = "science_history";
UPDATE `widget` SET `title_cs` = "Holokaust" WHERE `name` = "holocaust";
UPDATE `widget` SET `title_cs` = "Humorná literatura" WHERE `name` = "humorous";
UPDATE `widget` SET `title_cs` = "J. R. R. Tolkien" WHERE `name` = "tolkien";
UPDATE `widget` SET `title_cs` = "Jaroslav Foglar" WHERE `name` = "foglar";
UPDATE `widget` SET `title_cs` = "Jaroslav Seifert" WHERE `name` = "seifert";
UPDATE `widget` SET `title_cs` = "Kaktusy a sukulenty" WHERE `name` = "cactus";
UPDATE `widget` SET `title_cs` = "Karel Čapek" WHERE `name` = "Karel Čapek";
UPDATE `widget` SET `title_cs` = "Karel IV." WHERE `name` = "charles_IV";
UPDATE `widget` SET `title_cs` = "Kočka domácí" WHERE `name` = "cats";
UPDATE `widget` SET `title_cs` = "Koňské dostihy" WHERE `name` = "horse_racing";
UPDATE `widget` SET `title_cs` = "Kuchařky" WHERE `name` = "cookbooks";
UPDATE `widget` SET `title_cs` = "Lední hokej" WHERE `name` = "hockey";
UPDATE `widget` SET `title_cs` = "Lucemburkové" WHERE `name` = "luxembourg";
UPDATE `widget` SET `title_cs` = "Marie Terezie" WHERE `name` = "maria_theresa";
UPDATE `widget` SET `title_cs` = "Martin Luther" WHERE `name` = "martin_luther";
UPDATE `widget` SET `title_cs` = "Michal Viewegh" WHERE `name` = "michal_viewegh";
UPDATE `widget` SET `title_cs` = "Mineralogie" WHERE `name` = "mineralogy";
UPDATE `widget` SET `title_cs` = "Na cesty" WHERE `name` = "for_travel";
UPDATE `widget` SET `title_cs` = "Národní obrození" WHERE `name` = "national_revival";
UPDATE `widget` SET `title_cs` = "Nejprodávanější knihy 2015 v ČR" WHERE `name` = "bestsellers_2015";
UPDATE `widget` SET `title_cs` = "Nejprodávanější knihy 2016 v ČR" WHERE `name` = "bestsellers_2016";
UPDATE `widget` SET `title_cs` = "Nejprodávanější knihy 2017 v ČR" WHERE `name` = "bestsellers_2017";
UPDATE `widget` SET `title_cs` = "Olomouc" WHERE `name` = "olomouc";
UPDATE `widget` SET `title_cs` = "Osvobozené divadlo" WHERE `name` = "liberated_theatre";
UPDATE `widget` SET `title_cs` = "Pes domácí" WHERE `name` = "dogs";
UPDATE `widget` SET `title_cs` = "Pokojové rostliny" WHERE `name` = "houseplants";
UPDATE `widget` SET `title_cs` = "Praha" WHERE `name` = "prague";
UPDATE `widget` SET `title_cs` = "Přemyslovci" WHERE `name` = "premyslid";
UPDATE `widget` SET `title_cs` = "Řád templářů" WHERE `name` = "templars";
UPDATE `widget` SET `title_cs` = "Robert Fulghum" WHERE `name` = "robert_fulghum";
UPDATE `widget` SET `title_cs` = "Ruční práce – pletení a háčkování" WHERE `name` = "knitcrocet";
UPDATE `widget` SET `title_cs` = "Severská krimi" WHERE `name` = "scandinavian_crime";
UPDATE `widget` SET `title_cs` = "Skauting" WHERE `name` = "scout";
UPDATE `widget` SET `title_cs` = "Star Trek" WHERE `name` = "star_trek";
UPDATE `widget` SET `title_cs` = "Star Wars" WHERE `name` = "star_wars";
UPDATE `widget` SET `title_cs` = "Terry Pratchett" WHERE `name` = "terry_pratchett";
UPDATE `widget` SET `title_cs` = "Tudorovci" WHERE `name` = "tudors";
UPDATE `widget` SET `title_cs` = "Warhammer" WHERE `name` = "warhammer";
UPDATE `widget` SET `title_cs` = "Warhammer 40 000" WHERE `name` = "warhammer_40000";
UPDATE `widget` SET `title_cs` = "Winston Churchill" WHERE `name` = "winston_churchill";
UPDATE `widget` SET `title_cs` = "Mezinárodní právo" WHERE `name` = "international_law";
UPDATE `widget` SET `title_cs` = "Ekonomika" WHERE `name` = "economy";
UPDATE `widget` SET `title_cs` = "Veřejná správa" WHERE `name` = "public_administration";
UPDATE `widget` SET `title_cs` = "Pivo - pivovarnictví - pivovary" WHERE `name` = "beer";
UPDATE `widget` SET `title_cs` = "Železnice a vlaky" WHERE `name` = "trains";
UPDATE `widget` SET `title_cs` = "Domácí a komunitní vzdělávání" WHERE `name` = "community_edu";
UPDATE `widget` SET `title_cs` = "Akvaristika" WHERE `name` = "fishkeeping";
UPDATE `widget` SET `title_cs` = "RAW FOOD" WHERE `name` = "raw_food";
UPDATE `widget` SET `title_cs` = "Cestování a spolucestování" WHERE `name` = "traveling";
UPDATE `widget` SET `title_cs` = "Zahrádkáři" WHERE `name` = "gardening";
UPDATE `widget` SET `title_cs` = "Běhání" WHERE `name` = "jogging";
UPDATE `widget` SET `title_cs` = "Japonsko" WHERE `name` = "japan";
UPDATE `widget` SET `title_cs` = "Josef Lada" WHERE `name` = "josef_lada";
UPDATE `widget` SET `title_cs` = "50 e-knih do nové čtečky" WHERE `name` = "top_50_ebooks";
UPDATE `widget` SET `title_cs` = "Jak na dárky" WHERE `name` = "christmas_gifts";
UPDATE `widget` SET `title_cs` = "Karel Čapek" WHERE `name` = "karel_capek";
UPDATE `widget` SET `title_cs` = "Jan Evangelista Purkyně" WHERE `name` = "purkyne";
UPDATE `widget` SET `title_cs` = "Století trampingu" WHERE `name` = "century_of_tramping";
UPDATE `widget` SET `title_cs` = "Mezinárodní vztahy" WHERE `name` = "irel_international_relationships";
