...
class AjaxController extends AjaxControllerBase
{
    ...
    public function updateSearchResultsAjax()
    {
        ...
        $types             = $this->params()->fromPost('types');
        $lookFors          = $this->params()->fromPost('lookFors');
        $groupOperators    = $this->params()->fromPost('groupOperators');
        $allGroupsOperator = $this->params()->fromPost('allGroupsOperator');
        ...
        try {
            ...
            $view['results'] = $results = $runner->run(
                $request, 'Solr', $this->getSearchSetupCallback()
            );
