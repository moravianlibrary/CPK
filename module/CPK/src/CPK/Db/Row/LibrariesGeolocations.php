<?php
/**
 * Row Definition for LibrariesGeolocations
 *
 * PHP version 5
 *
 ...
 * @link     http://vufind.org Main Site
 */
class LibrariesGeolocations extends RowGateway implements DbTableAwareInterface
{
    ...
    {
        parent::__construct('id', 'libraries_geolocations', $adapter);
    }
