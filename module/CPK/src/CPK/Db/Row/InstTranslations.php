<?php
/**
 * Row Definition for Institutions Translations
 *
 * PHP version 5
 *
...
class InstTranslations extends RowGateway implements DbTableAwareInterface
{
    ...
    {
        parent::__construct('id', 'inst_translations', $adapter);
    }
